...
$("#search-sem").on("change", function (e) {
  ...
  const sem1Menu = "<option value='cs11101'>Computer Science (CS11101)</option><option value='cs11102'>Introduction to Computer Systems (CS11102)</option><option value='ee11101'>Electrical Engineering (EE11101)</option><option value='hs11101'>Human Values & Effective Communication (HS11101)</option><option value='ma11101'>Mathematics (MA11101)</option><option value='ph11101'>Engineering Physics (PH11101)</option>";
  const sem2Menu = "<option value='cs12101'>Foundation of Computing (CS12101)</option><option value='cy12101'>Chemistry (CY12101)</option><option value='cy12102'>Environmental Studies (CY12102)</option><option value='ec12101'>Electronics and Communication (EC12101)</option><option value='hs12101'>Human Values & Effective Communication (HS12101)</option><option value='ma12101'>Mathematics (MA12101)</option>";
  const sem3Menu = "<option value='cs13101'>Data Structures & Algorithms (CS13101)</option><option value='cs13102'>Data Communication (CS13102)</option><option value='cs13103'>Digital Logic Design (CS13103)</option><option value='cs13104'>Object Oriented System Design (CS13104)</option><option value='cs13105'>Computational Mathematics (CS13105)</option><option value='cs13106'>Logic for Computer Science (CS13106)</option>";
  const sem4Menu = "<option value='cs14101'>Computer Networks (CS14101)</option><option value='cs14102'>Operating Systems (CS14102)</option><option value='cs14103'>Design & Analysis of Algorithms (CS14103)</option><option value='cs14104'>Computer Organization & Architecture (CS14104)</option><option value='cs14105'>Software Engineering (CS14105)</option><option value='cs14106'>Microprocessors & Microcontrollers (CS14106)</option>";
  const sem5Menu = "";
  const sem6Menu = "<option value='cs16101'>Cloud Computing (CS16101)</option><option value='cs16102'>Image Processing (CS16102)</option><option value='cs16103'>Cryptography and Network Security (CS16103)</option><option value='cs16104'>Machine Learning [Open Elective] (CS16104)</option><option value='cs16105'>Data Analytics (CS16105)</option><option value='hs16101'>Principles of Management (HS16101)</option>";
  const sem7Menu = "";
  const sem8Menu = "";

  switch (currentSemValue) {
    case 1:
      currentMenu = allOption + sem1Menu;
      break;
    case 2:
      currentMenu = allOption + sem2Menu;
      break;
    case 3:
      currentMenu = allOption + sem3Menu;
      break;
    case 4:
      currentMenu = allOption + sem4Menu;
      break;
    case 6:
      currentMenu = allOption + sem6Menu;
      break;
    default:
      currentMenu = allOption;
      break;
  }
